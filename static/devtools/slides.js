...
function handleDomLoaded() {
  ...
  document.body.addEventListener('keyup', handleBodyKeyDown, false);
...
function loadPersonalization(){
  ...
  [].forEach.call( document.querySelectorAll('*[contenteditable]'), function(elem){
    var value = localStorage.getItem(elem.id);
    if (!value) return;
